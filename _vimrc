...
if empty(glob('C:\Users\herb/vimfiles/autoload/plug.vim'))
    echo "Installing VimPlug..."
    silent !curl -fLo C:\Users\herb/vimfiles/autoload/plug.vim --create-dirs https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim
    autocmd VimEnter * PlugInstall
endif

"VimPlug
call plug#begin('C:\Users\herb/vimfiles/plugged')
